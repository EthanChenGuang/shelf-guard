...
**Verification depth scales with `asvs_level`** (see @/home/guang/Projects/Experiments/image-comparation/.cursor/gsd-core/references/security-asvs-levels.md for full definitions):
