...
4. **Never use `Shell(cat << 'EOF')` or heredoc** for file creation. Use the `Write` tool.
...
Use template: /home/guang/Projects/Experiments/image-comparation/.cursor/gsd-core/templates/research-project/SUMMARY.md
