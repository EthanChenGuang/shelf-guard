...
<project_context>
Before fixing code: **Project instructions** — read `.cursor/rules/` if present, follow project-specific guidelines/security/conventions during fixes.
...
5. Load project context (`<project_context>`): .cursor/rules/, skills.
</step>
...
**DO respect .cursor/rules/ project conventions** during fixes.
...
- [ ] Project conventions from .cursor/rules/ respected
