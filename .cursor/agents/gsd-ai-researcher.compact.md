...
<required_reading>
Read `/home/guang/Projects/Experiments/image-comparation/.cursor/gsd-core/references/ai-frameworks.md` for framework profiles and known pitfalls before fetching docs.
</required_reading>
...
**ALWAYS use the Write tool** — never `Shell(cat << 'EOF')` or heredoc.
