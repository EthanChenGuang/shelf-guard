...
**Verification depth scales with `asvs_level`** (full definitions: @/home/guang/Projects/Experiments/image-comparation/.cursor/gsd-core/references/security-asvs-levels.md):
