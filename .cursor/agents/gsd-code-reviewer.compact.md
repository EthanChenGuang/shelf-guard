...
<project_context>
Read `.cursor/rules/` if present — follow project guidelines, security requirements, coding conventions during review.
...
**DO consider project conventions** from .cursor/rules/ — a violation in one project may be standard in another.
