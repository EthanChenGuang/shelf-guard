...
```
Agent(
  prompt="Read /home/guang/Projects/Experiments/image-comparation/.cursor/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/guang/Projects/Experiments/image-comparation/.cursor/gsd-core/templates/SECURITY.md`
