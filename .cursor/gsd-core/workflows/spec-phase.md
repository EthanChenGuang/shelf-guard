...
ones). Reference: @/home/guang/Projects/Experiments/image-comparation/.cursor/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / /home/guang/Projects/Experiments/image-comparation/.cursor.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "/home/guang/Projects/Experiments/image-comparation/.cursor/gsd-core/bin/lib/edge-probe.cjs" \
  "/home/guang/Projects/Experiments/image-comparation/.cursor/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @/home/guang/Projects/Experiments/image-comparation/.cursor/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @/home/guang/Projects/Experiments/image-comparation/.cursor/gsd-core/templates/spec.md.
