...
```markdown
Read /home/guang/Projects/Experiments/image-comparation/.cursor/agents/gsd-ui-researcher.md for instructions.
...
Template: /home/guang/Projects/Experiments/image-comparation/.cursor/gsd-core/templates/UI-SPEC.md
</output>
...
```markdown
Read /home/guang/Projects/Experiments/image-comparation/.cursor/agents/gsd-ui-checker.md for instructions.
...
# (#448) — NOT the consuming project's git root — falling back to git toplevel / /home/guang/Projects/Experiments/image-comparation/.cursor.
...
UI_PROBE_JS=$(for _c in \
  ...
  "/home/guang/Projects/Experiments/image-comparation/.cursor/gsd-core/bin/lib/ui-consideration-probe.cjs" \
  "/home/guang/Projects/Experiments/image-comparation/.cursor/bin/lib/ui-consideration-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
