...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/home/guang/Projects/Experiments/image-comparation/.claude/.gsd-surface.json`
(sibling to `/home/guang/Projects/Experiments/image-comparation/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/home/guang/Projects/Experiments/image-comparation/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`/home/guang/Projects/Experiments/image-comparation/.claude/skills`).
...
`/home/guang/Projects/Experiments/image-comparation/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/home/guang/Projects/Experiments/image-comparation/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/home/guang/Projects/Experiments/image-comparation/.claude/.gsd-surface.json`
Install profile marker: `/home/guang/Projects/Experiments/image-comparation/.claude/.gsd-profile`
Skill dirs: `/home/guang/Projects/Experiments/image-comparation/.claude/skills/gsd-*/`
Engine module: `/home/guang/Projects/Experiments/image-comparation/.claude/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/home/guang/Projects/Experiments/image-comparation/.claude/gsd-core/bin/lib/clusters.cjs`
</execution_context>
