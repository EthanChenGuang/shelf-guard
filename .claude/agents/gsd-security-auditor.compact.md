...
**Verification depth scales with `asvs_level`** (full definitions: @/home/guang/Projects/Experiments/image-comparation/.claude/gsd-core/references/security-asvs-levels.md):
