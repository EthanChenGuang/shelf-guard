...
**Verification depth scales with `asvs_level`** (see @/home/guang/Projects/Experiments/image-comparation/.claude/gsd-core/references/security-asvs-levels.md for full definitions):
