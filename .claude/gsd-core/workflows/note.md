...
- **Global scope**: `/home/guang/Projects/Experiments/image-comparation/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/guang/Projects/Experiments/image-comparation/.claude/notes/`)
...
2. Glob `/home/guang/Projects/Experiments/image-comparation/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/home/guang/Projects/Experiments/image-comparation/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/guang/Projects/Experiments/image-comparation/.claude/notes/` — works in any directory
