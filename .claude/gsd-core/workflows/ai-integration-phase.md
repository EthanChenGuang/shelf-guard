...
<required_reading>
@/home/guang/Projects/Experiments/image-comparation/.claude/gsd-core/references/ai-frameworks.md
@/home/guang/Projects/Experiments/image-comparation/.claude/gsd-core/references/ai-evals.md
</required_reading>
...
```markdown
Read /home/guang/Projects/Experiments/image-comparation/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/home/guang/Projects/Experiments/image-comparation/.claude/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /home/guang/Projects/Experiments/image-comparation/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /home/guang/Projects/Experiments/image-comparation/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /home/guang/Projects/Experiments/image-comparation/.claude/agents/gsd-eval-planner.md for instructions.
