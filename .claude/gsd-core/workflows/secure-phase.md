...
```
Agent(
  prompt="Read /home/guang/Projects/Experiments/image-comparation/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/guang/Projects/Experiments/image-comparation/.claude/gsd-core/templates/SECURITY.md`
